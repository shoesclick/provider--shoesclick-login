...
public class SiteStorageProvider implements
        UserStorageProvider,
        UserLookupProvider,
        CredentialInputValidator {

    private SiteUserStore siteUserStore;
    KeycloakSession keycloakSession;
    ComponentModel componentModel;
    protected Map<String, UserModel> loadedUsers = new HashMap<>();

    public SiteStorageProvider(KeycloakSession session, ComponentModel model,
                               SiteUserStore siteUserStore) {
        this.siteUserStore = siteUserStore;
    ...
    public UserModel getUserByUsername(RealmModel realm, String username) {
        ...
        if (adapter == null) {
            User user = siteUserStore.getUser(username);
            if (user != null) {
    ...
    public boolean isConfiguredFor(RealmModel realm, UserModel user, String credentialType) {
        ...
        try {
            String password = siteUserStore.getUser(user.getUsername()).getPassword();
